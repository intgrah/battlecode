...
_B2: list[DslTurn] = [
    ...
    ba(NW),  # 7:  barrier (6,4) [replaces road]
    ba(NE),  # 8:  barrier (8,4)
    ba(E),  # 9:  barrier (8,5)
    ba(SE),  # 10: barrier (8,6)
]
