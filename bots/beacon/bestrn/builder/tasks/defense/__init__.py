...
DEFENSE_CHILDREN: Final[list[Policy]] = [ECON_INFRASTRUCTURE_GROUP, PolicyLeaf(name="extend_chain_in_range", fn_=extend_chain_in_range), HEAL_GROUP, PolicyLeaf(name="stalk_enemy", fn_=stalk_enemy), PolicyLeaf(name="deny_enemy_ore", fn_=deny_enemy_ore), PolicyLeaf(name="patrol_cheap", fn_=patrol_cheap), PolicyLeaf(name="claim_ore", fn_=claim_ore), PolicyLeaf(name="build_harvester", fn_=build_harvester), PolicyLeaf(name="extend_chain_approach", fn_=extend_chain_approach), PolicyLeaf(name="patrol_late", fn_=patrol_late), PolicyLeaf(name="opportunistic_attack", fn_=opportunistic_attack), PolicyLeaf(name="explore", fn_=explore), PolicyLeaf(name="wander", fn_=wander)]
DEFENSE_GROUP_INNER: TaskGroup = TaskGroup(name="defense", children=DEFENSE_CHILDREN, gate=None)
