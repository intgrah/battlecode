...
HEAL_CHILDREN: Final[list[Policy]] = [PolicyLeaf(name="heal_buildings", fn_=heal_buildings.heal_buildings), PolicyLeaf(name="heal_adjacent_builder", fn_=heal_adjacent_builder.heal_adjacent_builder), PolicyLeaf(name="heal_self", fn_=heal_self.heal_self)]
