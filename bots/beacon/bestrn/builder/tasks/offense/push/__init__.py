...
OFFENSE_PUSH_CHILDREN: Final[list[Policy]] = [PolicyLeaf(name="claim_offensive_ore", fn_=claim_offensive_ore.claim_offensive_ore), PolicyLeaf(name="place_offensive_sentinel", fn_=place_offensive_sentinel.place_offensive_sentinel), PolicyLeaf(name="split_before_sentinel", fn_=split_before_sentinel.split_before_sentinel), PolicyLeaf(name="build_offensive_harvester", fn_=build_offensive_harvester.build_offensive_harvester), PolicyLeaf(name="push_extend", fn_=push_extend.push_extend)]
OFFENSE_PUSH_GROUP_INNER: TaskGroup = TaskGroup(name="push", children=OFFENSE_PUSH_CHILDREN, gate=None)
