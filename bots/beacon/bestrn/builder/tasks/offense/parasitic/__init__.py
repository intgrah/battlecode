...
OFFENSE_PARASITIC_CHILDREN: Final[list[Policy]] = [PolicyLeaf(name="approach_harvester", fn_=approach_harvester.approach_harvester), PolicyLeaf(name="walk_to_cached_target", fn_=walk_to_cached_target.walk_to_cached_target), PolicyLeaf(name="chew_conveyor", fn_=chew_conveyor.chew_conveyor)]
OFFENSE_PARASITIC_GROUP_INNER: TaskGroup = TaskGroup(name="parasitic", children=OFFENSE_PARASITIC_CHILDREN, gate=None)
