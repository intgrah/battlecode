...
ECON_INFRASTRUCTURE_CHILDREN: Final[list[Policy]] = [PolicyLeaf(name="build_foundry", fn_=build_foundry.build_foundry), PolicyLeaf(name="place_gunner", fn_=place_gunner.place_gunner), PolicyLeaf(name="fix_enemy_conveyor", fn_=fix_enemy_conveyor.fix_enemy_conveyor), PolicyLeaf(name="guard_harvester_neighbours", fn_=guard_harvester_neighbours.guard_harvester_neighbours), PolicyLeaf(name="resolve_congestion", fn_=resolve_congestion.resolve_congestion)]
ECON_INFRASTRUCTURE_GROUP_INNER: TaskGroup = TaskGroup(name="infrastructure", children=ECON_INFRASTRUCTURE_CHILDREN, gate=None)
