...
ECON_CHILDREN: Final[list[Policy]] = [ECON_INFRASTRUCTURE_GROUP, PolicyLeaf(name="extend_chain_in_range", fn_=extend_chain_in_range), HEAL_GROUP, PolicyLeaf(name="deny_enemy_ore", fn_=deny_enemy_ore), PolicyLeaf(name="claim_ore", fn_=claim_ore), PolicyLeaf(name="build_harvester", fn_=build_harvester), PolicyLeaf(name="extend_chain_approach", fn_=extend_chain_approach), PolicyLeaf(name="opportunistic_attack", fn_=opportunistic_attack), PolicyLeaf(name="explore", fn_=explore), PolicyLeaf(name="wander", fn_=wander)]
