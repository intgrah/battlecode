...
class State:
    ...
    def __init__(self, ct: Controller, core_pos: tuple[int, int]) -> None:
        ...
        # -- Tracking harvesters this bot built --
        self.my_built_harvesters: set[int] = set()
        # -- Fortify tracking (ore tiles where this bot placed the harvester) --
        self.my_fortify_targets: set[int] = set()
