...
class State:
    ...
    def __init__(self, ct: Controller, core_pos: Position) -> None:
        ...
        # -- Chain plans (meeting points from MarkerChainPlan) --
        self.chain_plans: set[int] = set()  # tile indices of active meeting points
        self.pending_chain_plan: object | None = None  # MarkerChainPlan to write

        # -- Explore claims (tiles other builders are exploring toward) --
        self.explore_claims: set[int] = set()  # tile indices claimed by other builders
        self.pending_explore_claim: object | None = None  # MarkerExploreClaim to write
