...
/// transport is not inspected — inward guards / mis-pointed bridges /
/// splitters are accepted and sorted out at lay-time. Among feedable
/// cardinals, return the one closest (d²) to the chosen sink.
#[must_use]
