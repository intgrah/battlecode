...
pub fn render_sidebar(ui: &mut egui::Ui, app: &mut App) {
    ...
    egui::Frame::group(ui.style()).show(ui, |ui| {
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .selectable_label(matches!(app.mode, Mode::Erase), "erase")
                .clicked()
            {
                set_mode(app, Mode::Erase);
            }
            if ui
    ...
    for (&p, &n) in &counts {
        ...
        ui.horizontal(|ui| {
            ...
            if ui.small_button("+after").clicked() {
    ...
    ui.label("keys");
    ui.small("esc: view | e: erase | p: phase view");
    ui.small("1-9: phase view @ N");
    ui.small("letters c/a/s/b/h/f/g/n/k/l/w/r: place");
    ui.small("LMB drag (view): pan | wheel: zoom");
    ...
    ctx.input(|i| {
        for ev in &i.events {
            ...
            match key {
                ...
                egui::Key::E => set_mode(app, Mode::Erase),
