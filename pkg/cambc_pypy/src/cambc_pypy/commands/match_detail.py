...
_CONDITION_LABELS = {
    ...
    "axionite_collected": "Axionite Collected",
    "titanium_collected": "Titanium Collected",
    "harvesters": "Harvesters",
    "axionite_stored": "Axionite Stored",
    "titanium_stored": "Titanium Stored",
    "coinflip": "Coinflip",
    "timeout": "Timeout",
    "error": "Error",
}
...
def _show_match_detail(match_id: str) -> None:
    ...
    a_is_winner = (winner_id and winner_id == team_a_id) or (
        not winner_id and score_a > score_b
    )
    b_is_winner = (winner_id and winner_id == team_b_id) or (
        not winner_id and score_b > score_a
    )
    ...
    for g in games:
        ...
        raw_condition = g.get("winCondition", "?")
        condition = _CONDITION_LABELS.get(raw_condition, raw_condition)
...
def match_detail(match_id: str) -> None:
