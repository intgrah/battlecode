...
def starter() -> None:
    ...
    if include_maps:
        ...
        if count > 0:
            ...
            console.print(
                "  [yellow]No default maps found. Download maps from the platform.[/yellow]"
            )
    ...
    console.print(
        "  3. Edit your bot:  bots/starter/main.py"
        if include_bot
        else "  3. Write your bot: bots/<name>/main.py"
    )
    console.print(
        "  4. Submit:         cambc submit bots/starter"
        if include_bot
        else "  4. Submit:         cambc submit bots/<name>"
    )
