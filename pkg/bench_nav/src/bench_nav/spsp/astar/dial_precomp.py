...
from bench_nav.types import AlgoName, PrecompCtx

assert CE + 2 == 5


class AstarDialPrecomp(AstarBase):
    """Backward A* from goal to start, using BFS-from-start as the admissible heuristic.

    Caches BFS-from-start per source across queries.
    """

    NAME = AlgoName("astar-dial-precomp-bfs")
